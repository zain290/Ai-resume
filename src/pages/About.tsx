...
const DEFAULTS = {
  ...
  products_paragraphs: [
    ...
    "Built from the ground up, RezFix uses the renowned Google XYZ formula to score and refine your bullet points. By analyzing the job description you provide, we ensure your resume aligns perfectly with what recruiters are looking for.",
  ...
  faqs: [
    ...
    { question: 'Do I have to pay to use this?', answer: 'No, RezFix is completely free to use for job seekers.' },
  ],
